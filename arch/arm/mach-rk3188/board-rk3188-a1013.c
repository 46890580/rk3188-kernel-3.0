 ...
 * Power supply	|       DC12V,POE,Battery	DC12V,POE,Battery
 * Keyboard	|       8 key			PowerOn,Vol+,Vol-,Menu,Reset
 * GPS		|       N/A			Ublox GPS on UART1
 * RS232	|       $Both have RS232 on UART2, RS232 on UART3
 * USB Hub	|       $Both have GL850 On board
 * LCD		|       LVDS(1280x800)		RGB(800x480), LVDS(1024x600)
 * HDMI		|       N/A			N/A
 * AVout	|       N/A			N/A
 * 3G modem	|       3G dongle		UG95,3G dongle
 * Ethernet	|       RTL8152B		RTL8152B
 * Wifi/BT	|       AP6212,AP6210		AP6212,AP6210
 * GSENSOR	|       MMA8653			N/A
 * ----------------------------------------------------------------------------
 * TP IC	|       COF(ft5xxx,ilitek)	GSL3670
 * PMU		|       AXP228			AXP228
 * MCU		|	RK618			RK616
 * AVIN		|       N/A			ADV7180
 * RTC		|       HYM8653			HYM8653
...
#define BL_EN_PIN         RK30_PIN1_PA6
