...
/*
 * Part of difference between M7R and Q72
 *
 * Machine     |       Q72                     M7R
 * ----------------------------------------------------------------------------
 * Camera      |       Dual camera             Single camera
 * Power supply|       DC 5V, Battery          DC12V,POE,Battery
 * Keyboard    |       PowerOn,Vol+,Vol-       PowerOn,Vol+,Vol-,Menu,Reset
 * GPS         |       N/A                     Ublox GPS on UART1
 * RS232       |       N/A                     RS232 on UART2, RS232 on UART3
 * USB Hub     |       On HRB                  GL850 On board
 * LCD         |       LVDS(800x1280)          RGB(800x480), LVDS(1024x600)
 * HDMI        |       Support on LCDC0        N/A
 * AVout       |       RK1000 on LCDC0         N/A
 * 3G modem    |       3G dongle               UG95,3G dongle
 * Ethernet    |       N/A                     RTL8152B
 * Wifi/BT     |       AP6210                  AP6212,AP6210
 * GSENSOR     |       MMA8653                 N/A
 * ----------------------------------------------------------------------------
 * TP IC       |       GSL3670                 GSL3670
 * PMU         |       AXP228                  AXP228
 * AVIN        |       ADV7180                 ADV7180
 * RTC         |       HYM8653                 HYM8653
 * ----------------------------------------------------------------------------
 */
