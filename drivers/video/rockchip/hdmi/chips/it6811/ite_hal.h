#if !defined(ITE6811_HAL_H)
#define ITE6811_HAL_H
...
halReturn_t HalInstallIteMonRequestIrqHandler(void);
halReturn_t HalInstallIteExtDeviceIrqHandler(fwIrqHandler_t irqHandler);
halReturn_t HalRemoveIteMonRequestIrqHandler(void);
halReturn_t HalRemoveIteExtDeviceIrqHandler(void);
