...
#define GSLX680_I2C_NAME 	"gsl3670"
...
//	msleep(50);
//	gpio_set_value(EN_PORT,GPIO_HIGH);
//	msleep(100);
...
static u32 gsl_read_interface(struct i2c_client *client, u8 reg, u8 *buf, u32 num)
{
	...
	xfer_msg[0].buf = &reg;
	xfer_msg[0].scl_rate = 200*1000; //RK3066 RK2926 I2C报错时打开这个

	xfer_msg[1].addr = client->addr;
	xfer_msg[1].len = num;
	xfer_msg[1].flags |= I2C_M_RD;
	xfer_msg[1].buf = buf;
	xfer_msg[1].scl_rate = 200*1000; //RK3066 RK2926 I2C报错时打开这个
